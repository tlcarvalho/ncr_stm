...
topic_labels <- c(
  ...
  "2"  = "T02 — China's Rise and Economic Statecraft",
  ...
  "3"  = "T03 — NCR Causal Mechanisms: Intervening Variables",
  ...
  "4"  = "T04 — NCR Theory and the Global IR Debate",
  ...
  "5"  = "T05 — Domestic Institutions and Elite Strategies",
  ...
  "6"  = "T06 — Military Force and Intervention Decisions",
  ...
  "7"  = "T07 — US Hegemony and Geopolitical Competition",
  ...
  "8"  = "T08 — Threat Perception and Security Alignment Shifts",
  ...
  "9"  = "T09 — National Interest, Sovereignty, and Strategic Autonomy",
  ...
  "10" = "T10 — Strategic Culture and Middle Power Positioning"
)
...
ggplot(
  ...
  labs(
    ...
    subtitle = paste0(
      "Coefficient = marginal effect of having ≥1 author from a region on topic prevalence\n",
...
ggsave("stm_topic_proportions.png", width = 10, height = 6, dpi = 300)
